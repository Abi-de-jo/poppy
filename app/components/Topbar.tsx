...
export default function Topbar({ onMenuClick }: TopbarProps) {
  ...
  return (
    <div className="h-[58px] bg-[#111620] border-b border-[rgba(148,163,184,0.07)] px-[22px] flex items-center gap-3 flex-shrink-0 max-[900px]:px-3 max-[900px]:gap-2">
      <button 
        className="lg:hidden w-8 h-8 bg-transparent border border-[rgba(148,163,184,0.07)] rounded-[10px] text-[#94a3b8] cursor-pointer flex items-center justify-center transition-all duration-150 hover:bg-[#161d2a] hover:border-[rgba(148,163,184,0.12)] hover:text-[#e2e8f0] max-[900px]:w-[30px] max-[900px]:h-[30px]"
        title="Menu" 
        onClick={onMenuClick}
      >
